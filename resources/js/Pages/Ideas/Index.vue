...
<template>
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Idea Card -->
            <a v-for="idea in ideas" :key="idea.id"
                :href="route('ideas.show', {idea: idea.id})"
                class="block p-5 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition">
                ...
                <div class="flex items-start justify-between gap-4">
                    ...
                    <!-- AI Badge -->
                    <span v-if="idea.ai_assisted" class="inline-flex items-center p-0.5 text-xs font-semibold rounded-full
